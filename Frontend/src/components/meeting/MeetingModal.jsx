...
function MeetingModal({mentor, mentee, toggleModal, acceptMeeting, declineMeeting, selectedMeeting}) {
            ...
            <div className="modal-content">
                ...
                <div className='mm-body'>
                    ...
                    <div className='mm-btns'>
                        <button onClick={() => acceptMeeting(selectedMeeting.id)}>Accept</button>
                        <button onClick={() => declineMeeting(selectedMeeting.id)}>Decline</button>
                    </div>
                </div>
            </div>
        </div>
